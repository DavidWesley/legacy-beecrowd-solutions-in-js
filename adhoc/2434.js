...
function getMinimunSaleHistory(/** @type {number[]} */[...values], initialValue = 0) {
...
function main() {
	...
	const minimunSaleValueOnHistory = getMinimunSaleHistory(transationsValues, +openingBalance)
